...
const menuTitleElement = tripMainControlsElement.querySelector(`h2`);
...
render(tripDaysItemElement, createTripDayInfoTemplate());
...
for (let i = 0; i < TRIPS_COUNT; i++) {
  render(tripEventsListElement, createTripEventsItemTemplate());
}
